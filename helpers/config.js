...
const missingVars = [], requiredVars = ['DISCORD_APP_TOKEN', 'DISCORD_APP_ID'];
...
module.exports = {
    ...
    apis: {
        ...
        mot: {
            ...
            enabled: !!(process.env.MOT_API_KEY && process.env.MOT_CLIENT_ID && process.env.MOT_CLIENT_SECRET && process.env.MOT_CLIENT_AUTHORITY && process.env.MOT_CLIENT_SCOPE_URL),
        },
        vin: {
            ...
            enabled: !!(process.env.VIN_URL && process.env.VIN_AUTH_URL && process.env.VIN_USERNAME && process.env.VIN_PASSWORD),
        }
    },
    notifications: {
